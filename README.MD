...
- Meta Llama 2 local (work in progress)
...
- Add any number of PDF files with resumes to the [components/data](components/data/) folder. Files shall be named using
